...
public class LockUtil {
    ...
    * */
    ...
    public static boolean isNoSwitch(Activity activity) {
        long ts = System.currentTimeMillis();
        UsageStatsManager usageStatsManager = (UsageStatsManager) activity.getApplicationContext()
    ...
    * 设置lock状态
    * */
    public static void setLock(String packageName,boolean isLock){
